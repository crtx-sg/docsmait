...
from config import (
    DATAFRAME_HEIGHT, DEFAULT_EXPORT_FORMAT, EXPORT_FILENAME_FORMAT,
    MARKDOWN_TRUNCATE_LENGTH
)
                    ...
                    for i, record in enumerate(records, 1):
                        ...
                        for key, value in record.items():
                            if key != 'id' and value:  # Skip empty values and id
                                ...
                                if isinstance(value, str) and len(value) > MARKDOWN_TRUNCATE_LENGTH:
                                    value = value[:MARKDOWN_TRUNCATE_LENGTH] + "..."
